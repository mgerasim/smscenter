...
prompt Disabling triggers for SMSCENTER.ABONENT_GROUP_LINK...
alter table SMSCENTER.ABONENT_GROUP_LINK disable all triggers;
prompt Disabling triggers for SMSCENTER.ARCHIVE_MESSAGE...
alter table SMSCENTER.ARCHIVE_MESSAGE disable all triggers;
prompt Disabling triggers for SMSCENTER.ERRORS...
alter table SMSCENTER.ERRORS disable all triggers;
prompt Disabling triggers for SMSCENTER.GROUPS...
alter table SMSCENTER.GROUPS disable all triggers;
prompt Disabling triggers for SMSCENTER.STATUS_MSG...
alter table SMSCENTER.STATUS_MSG disable all triggers;
prompt Disabling triggers for SMSCENTER.TYPE_TASK...
alter table SMSCENTER.TYPE_TASK disable all triggers;
prompt Disabling triggers for SMSCENTER.TASKS...
alter table SMSCENTER.TASKS disable all triggers;
prompt Disabling triggers for SMSCENTER.MESSAGES...
alter table SMSCENTER.MESSAGES disable all triggers;
prompt Disabling triggers for SMSCENTER.TEMPLATES...
alter table SMSCENTER.TEMPLATES disable all triggers;
prompt Disabling triggers for SMSCENTER.USER_BRANCHE_LINK...
alter table SMSCENTER.USER_BRANCHE_LINK disable all triggers;
prompt Disabling foreign key constraints for SMSCENTER.USERS...
alter table SMSCENTER.USERS disable constraint FK_USER_ROLES;
prompt Disabling foreign key constraints for SMSCENTER.ABONENTS...
alter table SMSCENTER.ABONENTS disable constraint FK_BRANCHES_ABONENTS;
alter table SMSCENTER.ABONENTS disable constraint FK_USERS_ABONENTS;
prompt Disabling foreign key constraints for SMSCENTER.GROUPS...
alter table SMSCENTER.GROUPS disable constraint FK_USER_GROUPS;
prompt Disabling foreign key constraints for SMSCENTER.TASKS...
alter table SMSCENTER.TASKS disable constraint FK_TYPE_TASK;
alter table SMSCENTER.TASKS disable constraint FK_USERS_TASKS;
prompt Disabling foreign key constraints for SMSCENTER.MESSAGES...
alter table SMSCENTER.MESSAGES disable constraint FK_STATUS_MSG;
alter table SMSCENTER.MESSAGES disable constraint FK_TASKS_NOTES;
alter table SMSCENTER.MESSAGES disable constraint FK_USERS;
prompt Disabling foreign key constraints for SMSCENTER.USER_BRANCHE_LINK...
alter table SMSCENTER.USER_BRANCHE_LINK disable constraint FK_BRANCHES;
alter table SMSCENTER.USER_BRANCHE_LINK disable constraint FK_USERS_2;
prompt Deleting SMSCENTER.USER_BRANCHE_LINK...
delete from SMSCENTER.USER_BRANCHE_LINK;
commit;
prompt Deleting SMSCENTER.TEMPLATES...
delete from SMSCENTER.TEMPLATES;
commit;
prompt Deleting SMSCENTER.MESSAGES...
delete from SMSCENTER.MESSAGES;
commit;
prompt Deleting SMSCENTER.TASKS...
delete from SMSCENTER.TASKS;
commit;
prompt Deleting SMSCENTER.TYPE_TASK...
delete from SMSCENTER.TYPE_TASK;
commit;
prompt Deleting SMSCENTER.STATUS_MSG...
delete from SMSCENTER.STATUS_MSG;
commit;
prompt Deleting SMSCENTER.GROUPS...
delete from SMSCENTER.GROUPS;
commit;
prompt Deleting SMSCENTER.ERRORS...
delete from SMSCENTER.ERRORS;
commit;
prompt Deleting SMSCENTER.ARCHIVE_MESSAGE...
delete from SMSCENTER.ARCHIVE_MESSAGE;
commit;
prompt Deleting SMSCENTER.ABONENT_GROUP_LINK...
delete from SMSCENTER.ABONENT_GROUP_LINK;
commit;
prompt Deleting SMSCENTER.ABONENTS...
delete from SMSCENTER.ABONENTS;
commit;
prompt Deleting SMSCENTER.USERS...
delete from SMSCENTER.USERS;
commit;
prompt Deleting SMSCENTER.USER_ROLES...
delete from SMSCENTER.USER_ROLES;
commit;
prompt Deleting SMSCENTER.BRANCHES...
delete from SMSCENTER.BRANCHES;
commit;
prompt Loading SMSCENTER.BRANCHES...
insert into SMSCENTER.BRANCHES (ID, S_NAME, NAME)
values (1, 'ХФ', 'Хабаровский филиал');
commit;
prompt 1 records loaded
prompt Loading SMSCENTER.USER_ROLES...
insert into SMSCENTER.USER_ROLES (ID, NAME, DESCRIPTION)
...
prompt Loading SMSCENTER.USERS...
insert into SMSCENTER.USERS (ID, LOGIN, CREATED_AT, UPDATED_AT, NAME, ROLE_ID)
...
commit;
prompt 3 records loaded
prompt Loading SMSCENTER.ABONENTS...
insert into SMSCENTER.ABONENTS (ID, NAME, PHONE, DESCRIPRION, BRANCHE_ID, USER_ID, DATE_CREATE, DATE_MODIFY)
...
prompt Loading SMSCENTER.ABONENT_GROUP_LINK...
insert into SMSCENTER.ABONENT_GROUP_LINK (ID, GROUP_ID, ABONENT_ID)
values (1, 1, 1);
insert into SMSCENTER.ABONENT_GROUP_LINK (ID, GROUP_ID, ABONENT_ID)
values (2, 1, 2);
insert into SMSCENTER.ABONENT_GROUP_LINK (ID, GROUP_ID, ABONENT_ID)
...
prompt Loading SMSCENTER.ARCHIVE_MESSAGE...
prompt Table is empty
prompt Loading SMSCENTER.ERRORS...
insert into SMSCENTER.ERRORS (ID, NAME, DESCRIPTION)
...
prompt Loading SMSCENTER.GROUPS...
insert into SMSCENTER.GROUPS (ID, NAME, DESCRIPTION, BRANCHES_ID, USER_ID, DATE_CREATE, DATE_MODIFY, IS_DELETE)
...
prompt Loading SMSCENTER.STATUS_MSG...
insert into SMSCENTER.STATUS_MSG (ID, NAME)
values (1, 'Создана');
insert into SMSCENTER.STATUS_MSG (ID, NAME)
...
prompt Loading SMSCENTER.TYPE_TASK...
insert into SMSCENTER.TYPE_TASK (ID, NAME, PRIORITY)
values (1, '?????????', 1);
insert into SMSCENTER.TYPE_TASK (ID, NAME, PRIORITY)
values (2, '?????????', 2);
insert into SMSCENTER.TYPE_TASK (ID, NAME, PRIORITY)
...
commit;
prompt 3 records loaded
prompt Loading SMSCENTER.TASKS...
insert into SMSCENTER.TASKS (ID, NAME, CREATED_AT, UPDATED_AT, TYPE_TASK_ID, USER_ID, GROUP_MSG, MESSAGE)
...
prompt Loading SMSCENTER.MESSAGES...
insert into SMSCENTER.MESSAGES (ID, PHONE, CREATED_AT, UPDATED_AT, TASK_ID, STATUS_ID, MESSAGE, USER_ID, ERROR_ID)
...
prompt Loading SMSCENTER.TEMPLATES...
prompt Table is empty
prompt Loading SMSCENTER.USER_BRANCHE_LINK...
prompt Table is empty
prompt Enabling foreign key constraints for SMSCENTER.USERS...
alter table SMSCENTER.USERS enable constraint FK_USER_ROLES;
prompt Enabling foreign key constraints for SMSCENTER.ABONENTS...
alter table SMSCENTER.ABONENTS enable constraint FK_BRANCHES_ABONENTS;
alter table SMSCENTER.ABONENTS enable constraint FK_USERS_ABONENTS;
prompt Enabling foreign key constraints for SMSCENTER.GROUPS...
alter table SMSCENTER.GROUPS enable constraint FK_USER_GROUPS;
prompt Enabling foreign key constraints for SMSCENTER.TASKS...
alter table SMSCENTER.TASKS enable constraint FK_TYPE_TASK;
alter table SMSCENTER.TASKS enable constraint FK_USERS_TASKS;
prompt Enabling foreign key constraints for SMSCENTER.MESSAGES...
alter table SMSCENTER.MESSAGES enable constraint FK_STATUS_MSG;
alter table SMSCENTER.MESSAGES enable constraint FK_TASKS_NOTES;
alter table SMSCENTER.MESSAGES enable constraint FK_USERS;
prompt Enabling foreign key constraints for SMSCENTER.USER_BRANCHE_LINK...
alter table SMSCENTER.USER_BRANCHE_LINK enable constraint FK_BRANCHES;
alter table SMSCENTER.USER_BRANCHE_LINK enable constraint FK_USERS_2;
prompt Enabling triggers for SMSCENTER.BRANCHES...
alter table SMSCENTER.BRANCHES enable all triggers;
prompt Enabling triggers for SMSCENTER.USER_ROLES...
alter table SMSCENTER.USER_ROLES enable all triggers;
prompt Enabling triggers for SMSCENTER.USERS...
alter table SMSCENTER.USERS enable all triggers;
prompt Enabling triggers for SMSCENTER.ABONENTS...
alter table SMSCENTER.ABONENTS enable all triggers;
prompt Enabling triggers for SMSCENTER.ABONENT_GROUP_LINK...
alter table SMSCENTER.ABONENT_GROUP_LINK enable all triggers;
prompt Enabling triggers for SMSCENTER.ARCHIVE_MESSAGE...
alter table SMSCENTER.ARCHIVE_MESSAGE enable all triggers;
prompt Enabling triggers for SMSCENTER.ERRORS...
alter table SMSCENTER.ERRORS enable all triggers;
prompt Enabling triggers for SMSCENTER.GROUPS...
alter table SMSCENTER.GROUPS enable all triggers;
prompt Enabling triggers for SMSCENTER.STATUS_MSG...
alter table SMSCENTER.STATUS_MSG enable all triggers;
prompt Enabling triggers for SMSCENTER.TYPE_TASK...
alter table SMSCENTER.TYPE_TASK enable all triggers;
prompt Enabling triggers for SMSCENTER.TASKS...
alter table SMSCENTER.TASKS enable all triggers;
prompt Enabling triggers for SMSCENTER.MESSAGES...
alter table SMSCENTER.MESSAGES enable all triggers;
prompt Enabling triggers for SMSCENTER.TEMPLATES...
alter table SMSCENTER.TEMPLATES enable all triggers;
prompt Enabling triggers for SMSCENTER.USER_BRANCHE_LINK...
alter table SMSCENTER.USER_BRANCHE_LINK enable all triggers;
set feedback on
set define on
prompt Done.
